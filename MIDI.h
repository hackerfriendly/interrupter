...
#define MIDI_CHANNEL_OMNI		0       // all midi devices must respond to ch 0
#define MIDI_CHANNEL_IN     1       // input midi channel to use
...
private:
	...
	unsigned int	mPendingMessageExpectedLength;
